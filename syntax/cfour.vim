...
syntax match c4key 'ABCDTYPE' nextgroup=@c4kwVal contained skipwhite
syntax match c4key 'BASIS' nextgroup=c4separator,basisInput contained skipwhite
...
syntax match c4key 'CHARGE' nextgroup=@c4kwVal contained skipwhite
syntax match c4key 'COORD' nextgroup=@c4kwVal contained skipwhite
syntax match c4key 'CONTINUUM' nextgroup=@c4kwVal contained skipwhite
syntax match c4key 'DERIV_LEV' nextgroup=@c4kwVal contained skipwhite
syntax match c4key 'EOMFOLLOW' nextgroup=@c4kwVal contained skipwhite
syntax match c4key 'ESTATE_CONV' nextgroup=@c4kwVal contained skipwhite
sy keyword c4key ESTATE_MAXC[YC] nextgroup=@c4kwVal contained skipwhite
syntax match c4key 'ESTATE_PROP' nextgroup=@c4kwVal contained skipwhite
syntax match c4key 'ESTATE_SYM' nextgroup=c4separator contained skipwhite
syntax match c4key 'EVAL_HESS' nextgroup=@c4kwVal contained skipwhite
syntax match c4key 'EXCITE' nextgroup=c4separator,c4excitevalue contained skipwhite
sy keyword c4key FREQ_ALGO[RITHM] nextgroup=@c4kwVal contained skipwhite
syntax match c4key 'FROZEN_CORE' nextgroup=@c4kwVal contained skipwhite
syntax match c4key 'GEO_CONV' nextgroup=@c4kwVal contained skipwhite
syntax match c4key 'GEO_MAXCYC' nextgroup=@c4kwVal contained skipwhite
syntax match c4key 'GEO_MAXSTEP' nextgroup=@c4kwVal contained skipwhite
syntax match c4key 'GEO_METHOD' nextgroup=@c4kwVal contained skipwhite
syntax match c4key 'GRID' nextgroup=@c4kwVal contained skipwhite
syntax match c4key 'GRID_ALGORITHM' nextgroup=@c4kwVal contained skipwhite
syntax match c4key 'LINEQ_CONV' nextgroup=@c4kwVal contained skipwhite
sy keyword c4key NEGVAL nextgroup=@c4kwVal contained skipwhite
syntax match c4key 'MEMORY' nextgroup=@c4kwVal contained skipwhite
syntax match c4key 'MEM_UNIT' nextgroup=@c4kwVal contained skipwhite
syntax match c4key 'MULTIPLICITY' nextgroup=@c4kwVal contained skipwhite
sy keyword c4key MULT[IPLICITY] nextgroup=@c4kwVal contained skipwhite
syntax match c4key 'NACOUP' nextgroup=@c4kwVal contained skipwhite
syntax match c4key 'RESTART_CC' nextgroup=@c4kwVal contained skipwhite
syntax match c4key 'SCF_CONV' nextgroup=@c4kwVal contained skipwhite
syntax match c4key 'SCF_DAMP' nextgroup=@c4kwVal contained skipwhite
syntax match c4key 'SCF_EXPORDER' nextgroup=@c4kwVal contained skipwhite
syntax match c4key 'SCF_PROG' nextgroup=@c4kwVal contained skipwhite
syntax match c4key 'TRANGRAD' nextgroup=@c4kwVal contained skipwhite
syntax match c4key 'UNITS' nextgroup=@c4kwVal contained skipwhite
syntax match c4key 'VIB' nextgroup=@c4kwVal contained skipwhite
" }}}
